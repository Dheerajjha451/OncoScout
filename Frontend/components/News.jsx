...
const News = () => {
  ...
  const API_KEY = "cf47b5871b5e4e9cb925242fc564c991 ";//api key
  ...
  useEffect(() => {
    ...
    const fetchNews = async () => {
      ...
      try {
        ...
        setNews(prevNews => [...prevNews, ...brainTumorResponse.data.articles, ...lungCancerResponse.data.articles]);
        setLoading(false);
      } catch (error) {
  ...
  return (
    <div>
      <h2 className="text-2xl font-bold mb-4 text-center">Latest News and Research on Brain Tumors and Lung Cancer</h2>
