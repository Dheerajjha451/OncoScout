...
export default function RegisterForm() {
  ...
  return (
    ...
    <div className="flex justify-center items-center h-screen ">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center shadow-lg p-8">
          ...
          <h1 className="text-4xl text-black font-bold my-4 mx-8 text-center font-Poppins">Create an account</h1>
            <form onSubmit={handleSubmit} className="flex flex-col gap-3 relative">
            <h1 className="text-black text-lg font-medium font-Poppins">Full Name</h1>  
              <input
              ...
              <Link href={"/"} passHref>
                <p className="text-sm mt-3 text-right">
                  Already have an account? <span className="underline text-fuchsia-600 ">Login</span>
                </p>
              </Link>
            </form>
          </div>
